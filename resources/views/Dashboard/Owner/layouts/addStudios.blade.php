        ...
        <form class="space-y-6" action="{{ route('store.studio') }}" method="POST" enctype="multipart/form-data">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4"
                    class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                    placeholder="Describe your studio" required></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="price" name="price" min="1" max="200"
                        class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
            ...
            <div class="border-t border-border pt-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center space-x-4">
                        <select id="add-availability-type" name="availability_type"
                            class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent"
                            onchange="toggleCustomAvailability('add')">
                    ...
                    <div id="add-custom-availability-section" class="space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="date" id="availability-date" name="availability_dates[]"
                                    class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                            </div>
                            <div>
                                <label for="start-time" class="block text-light mb-2">Start Time</label>
                                <input type="time" id="start-time" name="start_times[]"
                                    class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                            </div>
                            <div>
                                <label for="end-time" class="block text-light mb-2">End Time</label>
                                <input type="time" id="end-time" name="end_times[]"
                                    class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                            </div>
                        </div>
                        <div id="add-additional-availability-slots"></div>
                        <button type="button" onclick="addAvailabilitySlot('add')"
                            class="mt-2 text-primary hover:text-primaryHover flex items-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2" aria-labelledby="recurring-days-label">
                                    <label
                                        class="flex items-center space-x-2 bg-inputBg p-2 rounded-md border border-border cursor-pointer hover:bg-darkAccent">
                                        <input type="checkbox" name="recurring_days[]" value="monday"
                                            class="form-checkbox h-4 w-4 text-primary border-border bg-inputBg rounded focus:ring-primary">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label for="recurring-start-time" class="block text-light mb-2">Start
                                            Time</label>
                                        <input type="time" id="recurring-start-time" name="recurring_start_time"
                                            class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                    </div>
                                    <div>
                                        <label for="recurring-end-time" class="block text-light mb-2">End Time</label>
                                        <input type="time" id="recurring-end-time" name="recurring_end_time"
                                            class="w-full p-3 bg-inputBg border border-border rounded-md text-light shadow-input focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent">
                                    </div>
                                </div>
                            </div>
            ...
            <div>
                ...
                <input type="file" id="studio_photos" name="photos[]" class="hidden" multiple
                    accept="image/*" />
                <div class="border-2 border-dashed border-border rounded-md p-8 text-center" id="drop-area">
                    ...
                    <button type="button"
                        ...
                        onclick="document.getElementById('studio_photos').click();">Select Files</button>
            ...
            <div class="flex justify-end space-x-4 pt-4 border-t border-border">
                <button type="button" onclick="closeAddStudioModal()"
                ...
                <button type="submit"
                    class="bg-primary hover:bg-primaryHover text-white py-2 px-6 rounded-md transition-all duration-200 cursor-pointer">Add
                    Studio</button>
            </div>
        </form>
    </div>
