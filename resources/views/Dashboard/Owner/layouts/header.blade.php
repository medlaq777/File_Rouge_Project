...
<header class="fixed w-full bg-darkBg bg-opacity-95 backdrop-blur-sm z-50 border-b border-border">
    <nav class="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
      <a href="#" class="flex items-center gap-2">
        <i class="fas fa-music text-primary h-8 w-8"></i>
    ...
    <div id="mobile-menu" class="md:hidden hidden bg-darkAccent border-b border-border">
      <div class="px-4 py-3 space-y-3">
        ...
        <a href="#" class="block text-textMuted hover:text-light font-medium py-2 border-l-2 border-transparent hover:border-primary pl-3 transition-all duration-200">
