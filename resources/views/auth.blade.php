...
<html lang="en">
  <head>
    ...
    <title>StudioSpace - Authentication</title>
  ...
  >
    <div class="w-full max-w-md animate-fade-in">
      ...
      >
        <div class="flex">
          <button
            id="login-tab"
            class="flex-1 py-4 px-6 text-center font-medium text-primary border-b-2 border-primary transition-all duration-200 ease-in-out"
          >
            Login
          </button>
          <button
            id="register-tab"
            class="flex-1 py-4 px-6 text-center font-medium text-textMuted hover:text-gray-300 border-b-2 border-transparent transition-all duration-200 ease-in-out"
          >
            Register
          </button>
        </div>

        <div id="login-form" class="p-6 custom-scrollbar">
        ...
        <div id="register-form" class="p-6 hidden custom-scrollbar">
          <form id="register-form-element" class="space-y-4">
            ...
            <div class="flex items-start mt-2">
              ...
              <div class="ml-3 text-sm">
                <label for="terms" class="text-textMuted"
                  >I agree to the
                  <a href="#" class="text-primary hover:text-primaryHover"
                    >Terms of Service</a
                  >
                  and
                  <a href="#" class="text-primary hover:text-primaryHover"
    ...
    <script>
      ...
      function showLogin() {
        ...
        loginTab.classList.remove("text-textMuted", "border-transparent");
        registerTab.classList.add("text-textMuted", "border-transparent");
      ...
      function showRegister() {
        ...
        registerTab.classList.remove("text-textMuted", "border-transparent");
        loginTab.classList.add("text-textMuted", "border-transparent");
      ...
      registerFormElement.addEventListener("submit", function (e) {
        ...
        showFeedback("Registration successful! Welcome to StudioSpace!");
      });

      const radioContainers = document
        .querySelectorAll('input[type="radio"]')
        .forEach((radio) => {
          radio.closest("div").addEventListener("click", function () {
            ...
            document
              ...
              .forEach((r) => {
                ...
                if (r.checked) {
                  ...
                  container.classList.add("bg-opacity-90");
                } else {
                  container.classList.remove("border-primary");
                  container.classList.remove("bg-opacity-90");
                }
              });
          });
        });
