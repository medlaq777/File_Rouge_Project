    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="bg-darkUI rounded-xl p-6 shadow-lg sticky top-24">
                    ...
                    <ul class="space-y-3">
                        ...
                        <li>
                            <a href="#faq4" class="text-primary hover:text-primaryHover">How are royalties
                                calculated?</a>
                        </li>
                        <li>
                            <a href="#faq7" class="text-primary hover:text-primaryHover">Can I change my
                                subscription?</a>
                        </li>
                        <li>
                            <a href="#faq12" class="text-primary hover:text-primaryHover">What audio formats are
                                supported?</a>
                        </li>
                        <li>
            ...
            <div class="lg:col-span-3">
                ...
                <div class="mb-12">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="faq1" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            <button
                                class="w-full px-6 py-4 text-left text-light font-medium flex justify-between items-center"
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    ...
                                    of our website.
                                    You can register using your email address or sign up with your Google or Apple
                                    account.
                        ...
                        <div id="faq2" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <ul class="list-disc pl-6 text-textMuted mb-3">
                                    <li><strong class="text-light">Free Plan:</strong> Basic access with limited uploads
                                        and standard analytics</li>
                                    <li><strong class="text-light">Pro Plan ($9.99/month):</strong> Unlimited uploads,
                                        advanced analytics, and priority distribution</li>
                                    <li><strong class="text-light">Premium Plan ($19.99/month):</strong> Everything in
                                        Pro, plus exclusive promotional opportunities, 1-on-1 support, and custom
                                        profile features</li>
                                </ul>
                                <p class="text-textMuted">
                                    All paid plans come with a 7-day free trial. You can upgrade or downgrade your plan
                        ...
                        <div id="faq3" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    BeatRecords is currently available in over 180 countries worldwide. However, some
                                    features may be limited in certain regions due to licensing restrictions.
                                    To check if our service is fully available in your country, please visit our
                                    regional availability page or contact our support team.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-12">
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="faq4" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    To reset your password, click on "Sign In" and then select "Forgot Password." Enter
                                    the email address associated with your account,
                                    and we'll send you instructions to reset your password. For security reasons, the
                                    reset link is only valid for 24 hours.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="faq5" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    To update your profile, go to your account settings by clicking on your profile
                                    picture in the top-right corner and selecting "Profile Settings."
                                    Here you can edit your name, bio, profile picture, social media links, and other
                                    information. Don't forget to click "Save Changes" when you're done.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="faq6" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <p class="text-textMuted mt-3">
                                    We strongly recommend enabling two-factor authentication for enhanced account
                                    security.
                                </p>
                            </div>
                        </div>
                ...
                <div class="mb-12">
                    <h2 class="text-3xl font-bold text-light mb-6 border-b border-border pb-3">Subscription & Billing
                    </h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="faq7" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    ...
                                    Upgrades give you immediate access to new features, while downgrades will be applied
                        ...
                        <div id="faq8" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    ...
                                    Here you can add a new payment method or edit existing ones.
                                    We accept major credit cards, PayPal, and in some regions, direct bank transfers.
                                    For security, you may need to verify your identity when changing payment methods.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="faq9" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted">
                                    To cancel your subscription, go to Account Settings > Billing > Subscription
                                    Management and click "Cancel Subscription."
                                    You'll continue to have access to your subscription benefits until the end of your
                ...
                <div class="mb-12">
                    <h2 class="text-3xl font-bold text-light mb-6 border-b border-border pb-3">Uploading & Managing
                        Music</h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="faq11" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <ul class="list-disc pl-6 text-textMuted mt-3">
                                    <li><strong class="text-light">Free Plan:</strong> Up to 5 tracks per month, 25
                                        tracks total</li>
                                    <li><strong class="text-light">Pro Plan:</strong> 100 tracks per month, unlimited
                                        total</li>
                        ...
                        <div id="faq12" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <p class="text-textMuted mt-3">
                                    For the best quality, we recommend uploading WAV files at 44.1kHz, 24-bit depth.
                                    Maximum file size per track is 2GB.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-12">
                    <h2 class="text-3xl font-bold text-light mb-6 border-b border-border pb-3">Distribution & Royalties
                    </h2>
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="faq13" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <p class="text-textMuted mt-3">
                                    We pay out 85% of all revenue generated by your music directly to you. Royalties are
                                    calculated monthly and paid out when you reach the minimum threshold of $50.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="faq14" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                <p class="text-textMuted mb-3">
                                    ...
                                    provided you've reached the minimum payout threshold of $50.
                                </p>
                                <p class="text-textMuted mb-3">
                                ...
                                <p class="text-textMuted mt-3">
                                    You can set up and manage your payment preferences in your Account Settings >
                                    Payments section.
                                </p>
                            </div>
                        </div>
                        ...
                        <div id="faq15" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <p class="text-textMuted mt-3">
                                    Distribution times vary by platform, but typically take 1-3 business days for our
                                    platform and 3-14 days for external platforms.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div id="faq16" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <p class="text-textMuted mt-3">
                                    If the issue persists, please contact our support team with your upload ID (found in
                        ...
                        <div id="faq18" class="bg-darkUI rounded-lg overflow-hidden animate-fade-in scroll-mt-24">
                            ...
                            <div class="px-6 pb-4 hidden">
                                ...
                                <p class="text-textMuted mt-3">
                                    <strong class="text-light">Important:</strong> Account deletion is permanent and
                                    cannot be undone. All your uploaded content, statistics, and earnings history will
                                    be permanently deleted. Any pending payouts will still be processed.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-darkUI rounded-xl p-8 shadow-lg animate-fade-in">
                    <div class="text-center">
                        ...
                        <a href="/help#contact-form"
                            class="inline-flex items-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-primary hover:bg-primaryHover">
                            Contact Support
                        </a>
                    </div>
                </div>
