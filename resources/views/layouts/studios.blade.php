                    ...
                    <div class="relative h-48 overflow-hidden">
                        ...
                        @if ($studio->badge)
                            <div class="absolute top-0 right-0 p-2">
                                <span
                                    class="bg-success text-white text-xs font-medium px-2.5 py-0.5 rounded">{{ $studio->badge }}</span>
                            </div>
                        @endif
                    </div>
                    <div class="p-4">
                        ...
                        <div class="mt-4 flex items-center justify-between">
                            ...
                            <button
                                class="px-3 py-1 bg-primary hover:bg-primaryHover text-white text-sm font-medium rounded">Book
                                Now</button>
                        </div>
                    </div>
                </div>
